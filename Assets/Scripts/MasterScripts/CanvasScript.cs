...
public class CanvasScript : MonoBehaviour {
	...
	public void updateAll(){
		...
		if (numberMaster.scatterLevel < 5){
			Abilities [5].transform.GetChild (0).transform.FindChild ("LevelText").GetComponent<Text> ().text = 
			...
			Abilities [5].transform.GetChild (0).transform.FindChild ("LevelText").GetComponent<Text> ().text = "Lvl. Max";
			Abilities [5].transform.GetChild (0).transform.FindChild ("GoldText").GetComponent<Text> ().text = "";
		}
		...
		if (numberMaster.punchthroughLevel < 5){
			Abilities [6].transform.GetChild(0).transform.FindChild ("LevelText").GetComponent<Text> ().text = 
			...
			Abilities [6].transform.GetChild (0).transform.FindChild ("LevelText").GetComponent<Text> ().text = "Lvl. Max";
			Abilities [6].transform.GetChild (0).transform.FindChild ("GoldText").GetComponent<Text> ().text = "";
		}
		...
		if (numberMaster.damageLevel < 5) {
			Abilities [7].transform.GetChild(0).transform.FindChild ("LevelText").GetComponent<Text> ().text = 
		...
		Abilities [7].transform.GetChild(0).transform.FindChild ("GoldText").GetComponent<Text> ().text = 
			...
			Abilities [7].transform.GetChild(0).transform.FindChild ("LevelText").GetComponent<Text> ().text = "Lvl. Max";
			Abilities [7].transform.GetChild (0).transform.FindChild ("GoldText").GetComponent<Text> ().text = "";
		}
		...
		if (numberMaster.canUpgradeArmour ())
			...
			Disable (Abilities [8]);
		if (numberMaster.armourLevel < 5) {
			Abilities [8].transform.GetChild(0).transform.FindChild ("LevelText").GetComponent<Text> ().text = 
			...
			Abilities [8].transform.GetChild(0).transform.FindChild ("LevelText").GetComponent<Text> ().text = "Lvl. Max"; 
			Abilities [8].transform.GetChild (0).transform.FindChild ("GoldText").GetComponent<Text> ().text = "";
		}
	}
}
